(function(cash) { "use strict";
 ...
 function setLocation(curLoc){
   ...
   $('nav a').click(function(){
       top_menu = $('nav a').index(this);
       if ($(this).hasClass('active')) {
           $(this).removeClass('active');
       } else {
           $('nav a').removeClass('active');
           $(this).addClass('active');
           $('body,html').stop(true,true).animate({'scrollTop':$('.scrollto').eq(top_menu).offset().top - $('.navigation').height() },800); 
...
$('.mobile-menu, .close-menu, nav a').on( "click", function() { 
